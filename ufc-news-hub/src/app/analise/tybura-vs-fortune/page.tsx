...
const analise: PrelimsAnalise = {
  ...
  fighter1_info: { nome: 'Marcin Tybura', record: '25-9-0', ultimasLutas: [{ result: 'L', opponent: 'Ante Delija', method: 'KO R2', event: 'UFC Paris' }] },
  ...
  prelims_analysis: {
    hero: { evento_nome: 'UFC Fight Night: Adesanya vs Pyfer', evento_data: '28 de Marco, 2026', categoria_peso: 'Peso Pesado (265 lbs)', num_rounds: 3, is_titulo: false, fighter1: { nome: 'Marcin Tybura', record: '25-9-0', ranking: 'N/R' }, fighter2: { nome: 'Tyrell Fortune', record: '17-3-0', ranking: 'N/R' } },
    comparacao_estatistica: {
      ...
      tale_of_tape: [
        ...
        { label: 'UFC Lutas', fighter1: '24 (!!)', fighter2: 'Debut', note: 'Tybura e um dos mais experientes da historia da divisao' },
    ...
    historico_lutas: {
      fighter1: { nome: 'Tybura', recent_fights: [
        { date: 'Out 2025', opponent: 'Ante Delija', result: 'L', method: 'KO R2', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Nocauteado em Paris. A 24a luta UFC de Tybura.' },
        { date: 'Jun 2025', opponent: 'Tai Tuivasa', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Dominou Tuivasa com wrestling.' },
      ] },
      fighter2: { nome: 'Fortune', recent_fights: [
        { date: 'Dez 2025', opponent: 'Rafael Silva', result: 'W', method: 'TKO R2', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Terceira vitoria seguida antes do debut UFC.' },
      ] },
    },
    perfil_habilidades: {
      skills: [
        { label: 'Experiencia UFC', valueA: 90, valueB: 20, labelA: 'Excelente', labelB: 'Ruim', advantage: 'fighter1', advantage_note: '24 lutas UFC. Tybura e um dos mais experientes da historia do peso-pesado.' },
    ...
    distribuicao_vitorias: {
      fighter1: { nome: 'Tybura', ko_tko: { count: 8, percent: 32 }, submission: { count: 8, percent: 32 }, decision: { count: 9, percent: 36 }, total_wins: 25 },
    ...
    previsao_final: {
      ...
      explanation: 'Fortune e mais jovem, mais fresco, com wrestling de base e 3 vitorias seguidas. Tybura tem experiencia massiva (24 lutas UFC) mas vem de nocaute e parece em declinio aos 38 anos. Fortune deve usar o wrestling e a juventude pra controlar por 3 rounds. Mas Tybura e extremamente duro e ja surpreendeu muita gente.',
