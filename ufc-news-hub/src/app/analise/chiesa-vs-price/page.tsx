  ...
  full_analysis: {
    ...
    momento_atual: {
      fighter1: {
        ...
        full_fight_history: [
          { date: 'Nov 2023', opponent: 'Kevin Holland', result: 'L', method: 'Sub R1', opponent_rank: '#12 WW', quality_score: 3, quality_label: 'Bom', note: 'Guilhotina rapida' },
          { date: 'Jul 2024', opponent: 'Tony Ferguson', result: 'W', method: 'UD', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Wrestling dominante' },
          { date: 'Jan 2025', opponent: 'Max Griffin', result: 'W', method: 'UD', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Grappling' },
          { date: 'Jun 2025', opponent: 'Court McGee', result: 'W', method: 'UD', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Veterano' },
        ],
        momentum_score: 7,
      ...
      fighter2: {
        ...
        full_fight_history: [
          { date: 'Jun 2024', opponent: 'Alex Morono', result: 'W', method: 'UD', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Ultima vitoria' },
          { date: 'Out 2024', opponent: 'Themba Gorimbo', result: 'L', method: 'UD', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Dominado' },
          { date: 'Jun 2025', opponent: 'Jacobe Smith', result: 'L', method: 'Sub R2', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Finalizado' },
          { date: 'Fev 2026', opponent: 'Nikolay Veretennikov', result: 'L', method: 'KO R1', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Nocauteado' },
        ],
        momentum_score: 2,
