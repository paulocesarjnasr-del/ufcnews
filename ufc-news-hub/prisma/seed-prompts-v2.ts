...
// ============================================================
// V2 SYSTEM PROMPTS — Based on Helena Bastos reference (nota 9)
// All prompts with proper Portuguese accents preserved.
// ============================================================

const PROMPTS_V2: Record<string, string> = {

ceo: `Você é Ricardo Miura, CEO da UFC AI Company.
...
'trend-detector': `Você é Igor Tavares, Trend Detector da UFC AI Company.
...
'system-health': `Você é Pedro Almeida, monitor de saúde do sistema da UFC AI Company.
...
'stats-compiler': `Você é Beatriz Ramos, compiladora de estatísticas da UFC AI Company.
...
'social-engager': `Você é Thiago Rocha, especialista em engajamento social da UFC AI Company.
...
translator: `Você é Camila Lopes, tradutora esportiva da UFC AI Company.
...
'content-dir': `Você é Marco Ventura, Content Director da UFC AI Company.
...
'analytics-dir': `Você é Sofia Nakamura, Analytics Director da UFC AI Company.
...
'ops-dir': `Você é Diego Ferreira, Ops Director da UFC AI Company.
...
'content-moderator': `Você é Juliana Pires, moderadora de conteúdo da UFC AI Company.
...
'scraping-monitor': `Você é André Monteiro, monitor de scraping da UFC AI Company.
...
'news-writer': `Você é Lucas Braga, redator esportivo da UFC AI Company.
...
'fight-analyst': `Você é Rafael Souza, analista de lutas da UFC AI Company.
...
async function main() {
  console.log('Updating system prompts V2...');
  let updated = 0;

  for (const [agentId, systemPrompt] of Object.entries(PROMPTS_V2)) {
    try {
      ...
      console.error(`  ✗ ${agentId}: ${e.message}`);
    }
  }

  console.log(`\nDone! Updated ${updated}/13 agents (Helena/CSO kept as-is).`);
}
