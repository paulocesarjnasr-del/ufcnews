  ...
  return (
    <div className="min-h-screen bg-dark-bg">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        {/* UFC Fight Night: Emmett vs Vallejos — Full Card */}
        <div className="mt-12">
          <h2 className="mb-2 font-display text-2xl uppercase text-dark-text">
            UFC Fight Night: <span className="text-ufc-red">Emmett vs Vallejos</span>
          </h2>
          <p className="mb-6 text-sm text-dark-textMuted">14 de Marco, 2026 • UFC APEX, Las Vegas • 14 Lutas Analisadas</p>

          <div className="space-y-3">
            {[
              { slug: 'emmett-vallejos-ufn-mar-14', f1: 'Emmett', f2: 'Vallejos', cat: 'Peso Pena', tag: 'MAIN EVENT' },
              { slug: 'lemos-robertson-ufn-mar-14', f1: 'Lemos', f2: 'Robertson', cat: 'Peso Palha Fem.' },
              { slug: 'cutelaba-sy-ufn-mar-14', f1: 'Cutelaba', f2: 'Sy', cat: 'Meio-Pesado' },
              { slug: 'fili-delgado-ufn-mar-14', f1: 'Fili', f2: 'Delgado', cat: 'Peso Pena' },
              { slug: 'tavares-anders-ufn-mar-14', f1: 'Tavares', f2: 'Anders', cat: 'Peso Medio' },
              { slug: 'rahiki-hardwick-ufn-mar-14', f1: 'Rahiki', f2: 'Hardwick', cat: 'Peso Pena' },
              { slug: 'petrino-asplund-ufn-mar-14', f1: 'Petrino', f2: 'Asplund', cat: 'Peso Pesado' },
              { slug: 'johnson-silva-ufn-mar-14', f1: 'Johnson', f2: 'Silva', cat: 'Peso Mosca' },
              { slug: 'curtis-orolbai-ufn-mar-14', f1: 'Curtis', f2: 'Orolbai', cat: 'Meio-Medio' },
              { slug: 'oki-sousa-ufn-mar-14', f1: 'Oki', f2: 'Sousa', cat: 'Peso Leve' },
              { slug: 'lacerda-sosa-ufn-mar-14', f1: 'Lacerda', f2: 'Sosa', cat: 'Peso Galo' },
              { slug: 'mesquita-rendon-ufn-mar-14', f1: 'Mesquita', f2: 'Rendon', cat: 'Peso Galo Fem.' },
              { slug: 'smith-you-ufn-mar-14', f1: 'Smith', f2: 'You', cat: 'Peso Galo' },
              { slug: 'hughes-rodriguez-ufn-mar-14', f1: 'Hughes', f2: 'Rodriguez', cat: 'Peso Palha Fem.' },
            ].map((fight) => (
              <Link
                key={fight.slug}
                href={`/analise-completa/${fight.slug}`}
                className="group flex items-center justify-between rounded-lg border border-dark-border bg-dark-card p-4 transition-all hover:border-ufc-red/40 hover:shadow-lg hover:shadow-ufc-red/5"
              >
                <div className="flex items-center gap-3">
                  {fight.tag && (
                    <span className="rounded bg-ufc-red/20 px-2 py-0.5 text-xs font-bold text-ufc-red">{fight.tag}</span>
                  )}
                  <span className="font-display text-lg text-dark-text">
                    <span className="text-ufc-red">{fight.f1}</span> vs <span className="text-blue-400">{fight.f2}</span>
                  </span>
                  <span className="text-xs text-dark-textMuted">{fight.cat}</span>
                </div>
                <span className="text-sm font-bold text-ufc-red opacity-0 transition-opacity group-hover:opacity-100">
                  Ver Analise →
                </span>
              </Link>
            ))}
