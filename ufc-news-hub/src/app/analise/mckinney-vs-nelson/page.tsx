    ...
    momento_atual: {
      fighter1: {
        ...
        full_fight_history: [
          ...
          { date: 'Fev 2022', opponent: 'Fares Ziam', result: 'W', method: 'Sub R1 (RNC, 2:11)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Mata-leao rapido' },
          { date: 'Mar 2022', opponent: 'Drew Dober', result: 'L', method: 'TKO R1 (joelhada + socos)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Short notice, 14 dias apos Ziam' },
          { date: 'Ago 2022', opponent: 'Erick Gonzalez', result: 'W', method: 'Sub R1 (RNC, 2:17)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Mata-leao' },
          { date: 'Jan 2023', opponent: 'Ismael Bonfim', result: 'L', method: 'KO R2 (flying knee)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Joelhada voadora brutal' },
          { date: 'Jul 2023', opponent: 'Nazim Sadykhov', result: 'L', method: 'Sub R2 (RNC)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Submetido no R2' },
          { date: 'Ago 2023', opponent: 'Mike Breeden', result: 'W', method: 'TKO R1 (socos, 1:25)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Finish rapido' },
          { date: 'Out 2023', opponent: 'Brendon Marotte', result: 'W', method: 'TKO R1 (joelhada + GnP, 0:20)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: '20 segundos' },
          { date: 'Mai 2024', opponent: 'Esteban Ribovics', result: 'L', method: 'KO R1 (head kick, 0:37)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Nocauteado por chute na cabeca' },
          { date: 'Fev 2025', opponent: 'Damir Hadzovic', result: 'W', method: 'TKO R1 (GnP, 2:01)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Ground and pound' },
          { date: 'Jun 2025', opponent: 'Viacheslav Borshchev', result: 'W', method: 'Sub R1 (guilhotina, 0:55)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Guilhotina em 55s' },
          { date: 'Dez 2025', opponent: 'Chris Duncan', result: 'L', method: 'Sub R1 (anaconda choke, 2:30)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Anaconda choke' },
        ],
        momentum_score: 6,
      ...
      fighter2: {
        ...
        full_fight_history: [
          { date: 'Dez 2018', opponent: 'Carlos Diego Ferreira', result: 'L', method: 'TKO R2 (socos)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Debut UFC. Short notice substituindo Jesse Ronson.' },
          { date: 'Mai 2019', opponent: 'Matt Sayles', result: 'L', method: 'Sub R3 (arm-triangle)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Submetido no R3' },
          { date: 'Set 2019', opponent: 'Marco Polo Reyes', result: 'W', method: 'TKO R1 (socos, 1:36)', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Primeira vitoria UFC' },
          { date: 'Set 2020', opponent: 'Billy Quarantillo', result: 'L', method: 'KO R3 (soco)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'KO no inicio do R3' },
          { date: 'Jul 2022', opponent: 'Jai Herbert', result: 'L', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Retorno apos quase 2 anos fora. LW.' },
          { date: 'Fev 2023', opponent: 'Choi Doo-ho', result: 'D', method: 'Empate Majoritario', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Choi perdeu ponto por cabecada' },
          { date: 'Jun 2023', opponent: 'Blake Bilder', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'UFC 289 Vancouver' },
          { date: 'Set 2023', opponent: 'Fernando Padilla', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 1, quality_label: 'Ruim', note: 'Terceira vitoria seguida' },
          { date: 'Mar 2024', opponent: 'Bill Algeo', result: 'W', method: 'TKO R1 (socos, 4:00)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Finish solido contra veterano' },
          { date: 'Set 2024', opponent: 'Steve Garcia', result: 'L', method: 'TKO R1 (cotoveladas)', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Perdeu peso (148.5). Garcia substituiu Kattar.' },
          { date: 'Out 2025', opponent: 'Matt Frevola', result: 'W', method: 'Decisao Unanime', opponent_rank: 'N/R', quality_score: 2, quality_label: 'Medio', note: 'Retorno ao peso-leve. Vancouver.' },
        ],
        momentum_score: 6,
