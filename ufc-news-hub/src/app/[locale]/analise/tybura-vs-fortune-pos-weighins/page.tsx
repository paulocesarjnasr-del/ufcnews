...
const analise: PrelimsAnalise = {
  id: 'tybura-vs-fortune-pos-weighins', evento_id: null, slug: 'tybura-vs-fortune-pos-weighins', titulo: 'Tybura vs Fortune (Pos Weigh-Ins)', subtitulo: null, lutador1_id: null, lutador2_id: null, artigo_conteudo: '',
  ...
  prelims_analysis: {
    ...
    previsao_final: {
      ...
      explanation: 'Fortune e mais jovem, mais fresco, com wrestling de base e 3 vitorias seguidas. Tybura tem experiencia massiva (23 lutas UFC) mas vem de nocaute e parece em declinio aos 38 anos. Fortune deve usar o wrestling e a juventude pra controlar por 3 rounds. Mas Tybura e extremamente duro e ja surpreendeu muita gente. ATUALIZACAO POS WEIGH-INS: Ambos bateram o peso no limite do peso-pesado sem problemas, como esperado na divisao. O ponto mais relevante da pesagem e que este e o debut UFC de Fortune. Tybura, com 23 lutas no UFC, conhece a rotina da pesagem, do backstage, de tudo. Fortune esta experimentando isso pela primeira vez. Esse fator intangivel pode pesar tanto a favor (nervosismo de debut) quanto contra (motivacao extra). A previsao se mantem, mas a confianca permanece MEDIA porque debuts sao imprevisveis.',
      x_factor: { title: 'Debut UFC de Fortune', description: 'Estreia contra um veterano de 23 lutas. A pressao pode pesar ou pode motivar. O ambiente do octogono e diferente de tudo que Fortune ja experimentou.' },
      upset_alert: { title: 'Tybura Tem 23 Lutas UFC', description: 'A experiencia de Tybura nao pode ser subestimada. Ele sabe como funcionar no octogono melhor que quase qualquer um. E ja submeteu Tuivasa e venceu Romanov.' },
      probabilities: { fighter1: { nome: 'Tybura', percent: 40 }, fighter2: { nome: 'Fortune', percent: 58 }, draw: 2 },
      value_picks: {
        moneyline: { pick: 'Fortune (-180)', reasoning: 'Favorito justo pela juventude e wrestling. -180 e apertado dado que e debut, mas o atletismo deve prevalecer.' },
        ...
        best_value: 'Over 2.5 se Fortune usar wrestling. Debut e imprevisivel mas o estilo de luta aponta pra distancia.',
      },
    },
  },
};
