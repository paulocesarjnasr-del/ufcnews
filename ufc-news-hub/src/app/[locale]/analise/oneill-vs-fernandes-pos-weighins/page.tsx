...
const analise: PrelimsAnalise = {
  id: 'oneill-vs-fernandes-pos-weighins', evento_id: null, slug: 'oneill-vs-fernandes-pos-weighins', titulo: 'O\'Neill vs Fernandes (Pos Weigh-Ins)', subtitulo: null, lutador1_id: null, lutador2_id: null, artigo_conteudo: '',
  ...
  prelims_analysis: {
    hero: { evento_nome: 'UFC Fight Night: Adesanya vs Pyfer', evento_data: '28 de Marco, 2026', categoria_peso: 'Peso Mosca Feminino (125 lbs)', num_rounds: 3, is_titulo: false, fighter1: { nome: 'Casey O\'Neill', record: '10-2-0', ranking: '#12 WFLW', imagem_url: 'https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-03/ONEILL_CASEY_L_03-28.png?itok=MDa0OiVE' }, fighter2: { nome: 'Gabriella Fernandes', record: '11-3-0', ranking: '#14 WFLW', imagem_url: 'https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-08/FERNANDES_GABRIELLA_L_08-09.png?itok=7Gt6QPap' } },
    comparacao_estatistica: {
      ...
      tale_of_tape: [
        ...
        { label: 'Ranking', fighter1: '#12 WFLW', fighter2: '#14 WFLW', note: 'Confronto direto entre ranqueadas. Implicacoes na divisao.' },
    ...
    previsao_final: {
      ...
      explanation: 'O\'Neill era prospect top do peso-mosca antes da lesao. Voltou com vitoria solida. Fernandes e competitiva mas sem o nivel tecnico pra superar O\'Neill. O wrestling e o volume devem decidir por 3 rounds. ATUALIZACAO POS WEIGH-INS: Ambas bateram o peso em 125 lbs sem problemas. Este e um confronto entre a #12 e a #14 do ranking, dando peso extra ao resultado. Quem vencer sobe no ranking e se posiciona melhor na divisao. A pesagem nao trouxe surpresas, ambas pareceram profissionais e preparadas. A previsao se mantem inalterada.',
      ...
      upset_alert: { title: 'Fernandes E Dura', description: 'Fernandes tem 11-3 e nunca foi finalizada facilmente. Submeteu Wang Cong que era favorita. Pode tornar competitiva.' },
      probabilities: { fighter1: { nome: 'O\'Neill', percent: 62 }, fighter2: { nome: 'Fernandes', percent: 36 }, draw: 2 },
      value_picks: {
        moneyline: { pick: 'O\'Neill (-200)', reasoning: 'Favorita pela tecnica e experiencia. Confronto de ranqueadas (#12 vs #14) valida o preco.' },
        ...
        best_value: 'Over 2.5 rounds. Luta vai pros juizes quase certamente. Confronto de ranqueadas adiciona valor extra.',
      },
    },
  },
};
